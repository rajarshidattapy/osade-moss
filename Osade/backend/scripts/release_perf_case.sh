...
state="/var/tmp/osade-release-perf-$name"
xdg="$state/xdg"
runtime="$state/run"
...
launch_env=(env -u OSADE_BIN_PATH -u OSADE_ENV -u OSADE_SOCKET_PATH -u OSADE_CLIENT_SOCKET_PATH -u OSADE_RUNTIME_SESSION -u OSADE_STARTUP_CWD -u OSADE_WORKSPACE_ID -u OSADE_TAB_ID -u OSADE_PANE_ID XDG_CONFIG_HOME="$xdg" XDG_RUNTIME_DIR="$runtime" OSADE_DISABLE_SOUND=1 SHELL=/bin/sh)
control_env=(env -u OSADE_BIN_PATH -u OSADE_ENV -u OSADE_SOCKET_PATH -u OSADE_CLIENT_SOCKET_PATH -u OSADE_STARTUP_CWD -u OSADE_WORKSPACE_ID -u OSADE_TAB_ID -u OSADE_PANE_ID XDG_CONFIG_HOME="$xdg" XDG_RUNTIME_DIR="$runtime" OSADE_DISABLE_SOUND=1 SHELL=/bin/sh OSADE_RUNTIME_SESSION="$name")
...
socket="$xdg/osade/sessions/$name/osade.sock"
server_pid=
