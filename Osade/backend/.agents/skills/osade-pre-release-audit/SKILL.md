---
name: osade-pre-release-audit
description: Audit osade release readiness by comparing commits since the base release against next-release changelog and docs. Use when asked to run or apply the repo's pre-release audit, validate docs/next before release, inspect issue refs that release CI will close, or finalize release docs for osade.
---

# Osade Pre-release Audit
...
- checking `skills/osade/SKILL.md` against shipped CLI and agent-control behavior
