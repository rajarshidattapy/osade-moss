...
7. Audit next-release public docs.
   ...
   - Audit `skills/osade/SKILL.md` against shipped changes to the CLI, public IDs, pane and agent workflows, lifecycle semantics, and safety guidance. Flag stale commands, options, examples, or behavioral claims. The binary bundles this exact file, so review semantic freshness rather than file synchronization.
...
<whether skills/osade/SKILL.md matches the shipped CLI and agent-control behavior>
