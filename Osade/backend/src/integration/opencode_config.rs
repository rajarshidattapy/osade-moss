...
mod tests {
    ...
    fn add_and_remove_tui_plugin_preserves_jsonc_config() {
        ...
        add_tui_plugin(&dir, "./osade-tui-state.js").unwrap();
        add_tui_plugin(&dir, "./osade-tui-state.js").unwrap();
        ...
        assert!(remove_tui_plugin(&dir, "./osade-tui-state.js").unwrap());
    ...
    fn managed_jsonc_leaves_opencode_migration_target_absent() {
        ...
        let config_path = add_tui_plugin(&dir, "./osade-tui-state.js").unwrap();
        ...
        assert_eq!(
            ...
            json!({ "plugin": ["./osade-tui-state.js"] })
        );
    ...
    fn configured_tui_plugin_accepts_option_tuple() {
        ...
        fs::write(
            ...
            r#"{"plugin":[["./osade-tui-state.js",{"enabled":true}]]}"#,
        )
        .unwrap();

        assert!(tui_plugin_is_configured(&dir, "./osade-tui-state.js"));
        assert!(remove_tui_plugin(&dir, "./osade-tui-state.js").unwrap());
