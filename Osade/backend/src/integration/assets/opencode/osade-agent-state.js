...
// OSADE_INTEGRATION_ID=opencode
// OSADE_INTEGRATION_VERSION=10

import net from "node:net";

const SOURCE = "osade:opencode";
...
export const OsadeAgentStatePlugin = async () => {
  if (
    process.env.OSADE_ENV !== "1" ||
    !process.env.OSADE_SOCKET_PATH ||
    !process.env.OSADE_PANE_ID
  ) {
    return {};
  }
