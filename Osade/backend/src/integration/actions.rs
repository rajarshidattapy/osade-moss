    ...
    let mut messages = match target {
        ...
        crate::api::schema::IntegrationTarget::Droid => {
            ...
            if installed.updated_legacy_hooks {
                messages.push(format!(
                    "removed legacy osade droid hook entries from {}",
    ...
    let messages = match target {
        ...
        crate::api::schema::IntegrationTarget::Claude => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed osade claude hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade claude hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Codex => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed osade codex hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade codex hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages.push(format!(
        ...
        crate::api::schema::IntegrationTarget::Copilot => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed osade copilot hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade copilot hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Devin => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed osade devin hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade devin hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Kimi => {
            ...
            if result.updated_config {
                messages.push(format!(
                    "removed osade kimi hook entries from {}",
                    result.config_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade kimi hook entries found in {}",
                    result.config_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Droid => {
            ...
            if result.updated_hooks {
                ...
                messages.push(format!(
                    "no legacy osade droid hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            if result.updated_settings {
                messages.push(format!(
                    "removed osade droid hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade droid hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Opencode => {
            ...
            if result.updated_tui_config {
                messages.push(format!(
                    "removed osade opencode plugin entry from {}",
        ...
        crate::api::schema::IntegrationTarget::Qodercli => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed osade qodercli hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade qodercli hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Qwen => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed osade qwen hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade qwen hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Cursor => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed osade cursor hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade cursor hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Mastracode => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed osade mastracode hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade mastracode hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::AntigravityCli => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed osade antigravity-cli hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no osade antigravity-cli hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
